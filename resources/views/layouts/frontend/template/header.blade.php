...
<head>
	...
	<link rel="icon" href="{{ URL::asset('assets/frontend/images/falcon.jpg')}}">
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/frontend/css/jquery_ui.css')}}">
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/frontend/style.css?v=20230918')}}">
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="{{ URL::to('index.php')}}">{{ getSiteSetting() !== null ? getSiteSetting()->name : ''}}</a>
			...
			<div class="slider-item" style="background-image:url({{ URL::asset('assets/frontend/images/bg_2.jpg')}});">
				...
				<div class="container">
					<div class="row no-gutters slider-text align-items-center justify-content-end">
						<div class="col-md-6 ftco-animate">
							<div class="text">
								<h2> {{ getSiteSetting() !== null ? getSiteSetting()->name : ''}} &amp; Resort</h2>
